...
enum SPELLFAMILY
{
    ...
    SPELLFAMILY_ELE_BAR
    SPELLFAMILY_ELE_BAR_RA
    SPELLFAMILY_STATUS_BAR
    SPELLFAMILY_STATUS_BAR_RA

    SPELLFAMILY_RECALL

    SPELLFAMILY_CURA            = 14,
    SPELLFAMILY_ENFIRE          = 15,
    SPELLFAMILY_ENBLIZZARD      = 16,
    SPELLFAMILY_ENAERO          = 17,
    SPELLFAMILY_ENSTONE         = 18,
    SPELLFAMILY_ENTHUNDER       = 19,
    SPELLFAMILY_ENWATER         = 20,
    SPELLFAMILY_PHALANX         = 21,
    SPELLFAMILY_REGEN           = 22,
    SPELLFAMILY_REFRESH         = 23,

    SPELLFAMILY_SANDSTORM
    SPELLFAMILY_RAINSTORM
    SPELLFAMILY_WINDSTORM
    SPELLFAMILY_FIRESTORM
    SPELLFAMILY_HAILSTORM
    SPELLFAMILY_THUNDERSTORM
    SPELLFAMILY_VOIDSTORM
    SPELLFAMILY_AURORASTORM

    SPELLFMAILY_TELEPORT

    SPELLFAMILY_PROTECTRA       = 24,
    SPELLFAMILY_SHELLRA         = 25,
    SPELLFAMILY_RERAISE         = 26,
    SPELLFAMILY_FIRE            = 27,
    SPELLFAMILY_BLIZZARD        = 28,
    SPELLFAMILY_AERO            = 29,
    SPELLFAMILY_STONE           = 30,
    SPELLFAMILY_THUNDER         = 31,
    SPELLFAMILY_WATER           = 32,
    SPELLFAMILY_FIRAGA          = 33,
    SPELLFAMILY_BLIZZAGA        = 34,
    SPELLFAMILY_AEROGA          = 35,
    SPELLFAMILY_STONEGA         = 36,
    SPELLFAMILY_THUNDAGA        = 37,
    SPELLFAMILY_WATERGA         = 38,
    SPELLFAMILY_FLARE           = 39,
    SPELLFAMILY_FREEZE          = 40,
    SPELLFAMILY_TORNADO         = 41,
    SPELLFAMILY_QUAKE           = 42,
    SPELLFAMILY_BURST           = 43,
    SPELLFAMILY_FLOOD           = 44,
    SPELLFAMILY_GRAVITY         = 45,
    SPELLFAMILY_METEOR          = 46,
    SPELLFAMILY_POISON          = 47,
    SPELLFAMILY_POISONGA        = 48,
    SPELLFAMILY_BIO             = 49,

    SPELLFAMILY_ELE_DOT
    SPELLFAMILY_ABSORB

    SPELLFAMILY_DRAIN           = 50,
    SPELLFAMILY_ASPIR           = 51,

    SPELLFAMILY_SPIKES

    SPELLFAMILY_STATUS

    SPELLFAMILY_SLEEP           = 52,
    SPELLFAMILY_BLIND           = 53,
    SPELLFAMILY_WARP            = 54,
    SPELLFAMILY_TRACTOR         = 55,
    SPELLFAMILY_SLEEPGA         = 56,

    SPELLFAMILY_GEOHELIX
    SPELLFAMILY_HYDROHELIX
    SPELLFAMILY_ANEMOHELIX
    SPELLFAMILY_PYROHELIX
    SPELLFAMILY_CRYOHELIX
    SPELLFAMILY_IONOHELIX
    SPELLFAMILY_NOCTOHELIX
    SPELLFAMILY_LUMINOHELIX
    SPELLFAMILY_ADDLE
    ...
    SPELLFAMILY_KATON           = 57,
    SPELLFAMILY_HYOTON          = 58,
    SPELLFAMILY_HUTON           = 59,
    SPELLFAMILY_DOTON           = 60,
    SPELLFAMILY_RAITON          = 61,
    SPELLFAMILY_SUITON          = 62,
    SPELLFAMILY_UTSUSEMI        = 63,
    SPELLFAMILY_JUBAKU          = 64,
    SPELLFAMILY_HOJO            = 65,
    SPELLFAMILY_KURAYAMI        = 66,
    SPELLFAMILY_DOKUMORI        = 67,
    SPELLFAMILY_TONKO           = 68,

    SPELLFAMILY_STATUS_GA

    SPELLFAMILY_FOE_REQUIEM     = 69,
    SPELLFAMILY_HORDE_LULLABY   = 70,
    SPELLFAMILY_ARMYS_PAEON     = 71,
    SPELLFAMILY_MAGES_BALLAD    = 72,
    SPELLFAMILY_KNIGHTS_MINNE   = 73,
    SPELLFAMILY_VALOR_MINUET    = 74,
    SPELLFAMILY_MADRIGAL        = 75,
    SPELLFAMILY_PRELUDE         = 76,
    SPELLFAMILY_MAMBO           = 77,
    SPELLFAMILY_OPERETTA        = 78,
    SPELLFAMILY_MARCH           = 79,
    SPELLFAMILY_ELEGY           = 80,
    SPELLFAMILY_STR_ETUDE       = 81,
    SPELLFAMILY_DEX_ETUDE       = 82,
    SPELLFAMILY_VIT_ETUDE       = 83,
    SPELLFAMILY_AGI_ETUDE       = 84,
    SPELLFAMILY_INT_ETUDE       = 85,
    SPELLFAMILY_MND_ETUDE       = 86,
    SPELLFAMILY_CHR_ETUDE       = 87,
    SPELLFAMILY_FIRE_CAROL      = 88,
    SPELLFAMILY_ICE_CAROL       = 89,
    SPELLFAMILY_WIND_CAROL      = 90,
    SPELLFAMILY_EARTH_CAROL     = 91,
    SPELLFAMILY_LIGHTNING_CAROL = 92,
    SPELLFAMILY_WATER_CAROL     = 93,
    SPELLFAMILY_LIGHT_CAROL     = 94,
    SPELLFAMILY_DARK_CAROL      = 95,

    SPELLFAMILY_FIRE_THRENODY
    SPELLFAMILY_ICE_THRENODY
    SPELLFAMILY_WIND_THRENODY
    SPELLFAMILY_EARTH_THRENODY
    SPELLFAMILY_LIGHTNING_THRENODY
    SPELLFAMILY_WATER_THRENODY
    SPELLFAMILY_LIGHT_THRENODY
    SPELLFAMILY_DARK_THRENODY

    SPELLFAMILY_FOE_LULLABY     = 96,
    SPELLFAMILY_MAZURKA         = 97,
    ...
    SPELLFAMILY_INDI_BUFF
    SPELLFAMILY_INDI_DEBUFF
    SPELLFAMILY_GEO_BUFF
    SPELLFAMILY_GEO_DEBUFF

    SPELLFAMILY_FIRA
    SPELFAMILY_BLIZZARA
    SPELLFAMILY_AERORA
    SPELLFAMILY_STONERA
    SPELLFAMILY_THUNDARA
    SPELLFAMILY_WATERA

    SPELLFAMILY_DISTRACT        = 98,
    SPELLFAMILY_FRAZZLE         = 99,
    SPELLFAMILY_FLURRY          = 100,
};
